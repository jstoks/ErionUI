...
function ftext.fixFormatOptions(str, opts)
  ...
  if options.allBold == nil then
    options.allBold = false
  end
  if options.textBold == nil or options.allBold == true then
    options.textBold = false
  end
...
function ftext.fLine(str, opts)
  ...
  if options.textBold then
    fullText = string.format("<b>%s</b>", fullText)
  end
  ...
  if options.inside then
    ...
    -- "endcap================= some text"
    -- "some text =================endcap"
    finalString = string.format("%s%s%s%s%s", fullLeftCap, fullLeftSpacer, fullText, fullRightSpacer, fullRightCap)
  else
    -- "=====endcap some text endcap====="
    -- "=====endcap some text pacdne====="
    -- "=================endcap some text"
    ...
    finalString = string.format("%s%s%s%s%s", fullLeftSpacer, fullLeftCap, fullText, fullRightCap, fullRightSpacer)
  end

  if options.allBold then
    finalString = string.format("<b>%s</b>", finalString)
  end
